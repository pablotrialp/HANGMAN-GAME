...
function miedos() {
    iniciar(miedo);
    bodi.style.background = "url(./img/cementerio.jpg) no-repeat center";
...
//esta funcion es para que aparezca visible texto y btn1
...
// iba funcion agregar palabra en este lugar
